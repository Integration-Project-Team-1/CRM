...
public class SalesforceTest {
    ...
    public void testCreateConsumption() {
        // Mock Consumption object and Salesforce object
        Consumption consumption = mock(Consumption.class);
        Salesforce salesforce = mock(Salesforce.class);

        // Configure consumption mock
        ...
        // Call method to be tested
        assertDoesNotThrow(() -> salesforce.createConsumption(consumption), "Failed to create consumption");
